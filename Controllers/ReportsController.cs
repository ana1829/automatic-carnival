...
namespace ZooWebsite.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FName,LName")] Reports reports)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FName,LName")] Reports reports)
        {
            if (id != reports.Id)
            {
                return NotFound();
